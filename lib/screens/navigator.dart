...
class _navigatorState extends State<navigator> {
    ...
    List<Widget> screens = [Home(),Profile(),Card() ,Chat()];
    int  currentIndex = 0;
  @override
  ...
  tabBorderRadius: 10, 
  tabActiveBorder: Border.fromBorderSide(BorderSide.none), // tab button border
  tabBorder: Border.fromBorderSide(BorderSide.none), // tab button border
  ...
  textStyle: TextStyle(color: Colors.black),// selected tab background color
  ...
  tabs: [
    ...
    GButton(
      ...
      body: Container(child: screens.elementAt(currentIndex)),
    );
  }
}
