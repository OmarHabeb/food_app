...
class Rate_food extends StatefulWidget {
  ...
  @override
  State<Rate_food> createState() => _Rate_foodState();
}

class _Rate_foodState extends State<Rate_food> {
  @override
          ...
          child: Column(children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      image: AssetImage("assets/rate food.jpeg"),
                      fit: BoxFit.cover)),
            ),
            SizedBox(height: 30),
            Text(
                ...
                InkWell(
                  onTap: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => Rate_Restaurant()));
                  },
                  child: Container(
                    width: 82.w,
                    height: 57.h,
